...
<div id="page-container" class="hfeed site lazyload" data-bgset="<?php bloginfo('template_directory'); ?>/images/kl_bg500.jpg [(max-width: 720px)] | <?php bloginfo('template_directory'); ?>/images/kl_bg720.jpg [(max-width: 150px)] | <?php bloginfo('template_directory'); ?>/images/kl_bg.jpg " >
		...
		<div class="container">
			<div class="site-branding">
				...
				<div class="header-left">
					<a href="<?php echo esc_url( home_url( '/' ) ); ?>"><img  src=data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==></img></a>
